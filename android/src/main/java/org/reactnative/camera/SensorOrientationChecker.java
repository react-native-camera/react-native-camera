...
interface SensorOrientationListener {
...
public class SensorOrientationChecker {
    ...
    private SensorOrientationListener mListener = null;

    public SensorOrientationChecker(ThemedReactContext themedReactContext) {
        mSensorEventListener = new Listener();
        mSensorManager = (SensorManager) themedReactContext.getSystemService(Context.SENSOR_SERVICE);
    ...
    public void registerOrientationListener(SensorOrientationListener listener) {
