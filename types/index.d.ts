// Type definitions for react-native-camera 1.0 Definitions by Felipe
// Constantino <https://github.com/fconstant> If you modify this file, put your
// GitHub info here as well (for easy contacting purposes)
...
type AutoFocus = Readonly < {
  on: any,
  off: any
} >;
type FlashMode = Readonly < {
  on: any,
  off: any,
  torch: any,
  auto: any
} >;
type CameraType = Readonly < {
  front: any,
  back: any
} >;
...
type CameraStatus = Readonly < Self < {
  READY: any,
